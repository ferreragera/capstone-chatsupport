...
<head>
    ...
    <link rel="icon" href="{{ url_for('static', filename='CvSU-logo-trans.png') }}" sizes="192x192">
...
<body>
            ...
            <div class="modal-body">
                <form action="/save_feedback" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="Write a feedback..." class="form-control" id="message" name="feedmessage" rows="3" pattern="[a-zA-Z!?@\s]*" required></textarea>
                    </div>
    ...
    <!-- <div class="row">
        <div class="col-md-8">
        <br>
        LINKS FOR THE OTHER SATELLITE CAMPUSES:
        <br>
         <a href="https://cvsu-rosario.edu.ph/Online_Admission/online_admission.php">CCAT Campus Application</a>
        <br>
        <a href="https://cvsu-trececampus.com/">Trece Martires Campus</a> 
        </div>
     </div> -->
  </div>
                ...
                <script>
                    function validateInput(input) {
                        ...
                        if (!regex.test(input.value)) {
                            ...
                            alert("Please enter only text and the characters !?");
                        }
                    }
                </script>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    <script type="text/javascript" src="{{ url_for('static', filename='purify.min.js') }}"></script>
