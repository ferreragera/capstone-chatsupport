...
for (pattern_sentence, tag) in xy:
    augmented_data.append((pattern_sentence, tag))  # Add the original example
    ...
    for _ in range(num_augmented_samples):
        ...
        augmented_data.append((augmented_sentence.split(), tag))

# Update X_train and y_train with the augmented data
X_train = []
y_train = []

for (pattern_sentence, tag) in augmented_data:
